...
# --- Compose Scanning ---
IGNORE_DIRECTORIES = ["photos", "media", "documents", "windows", "system volume information", "$recycle.bin", "venv", ".venv", "Application Data", "Local Settings", "Temporary Internet Files"] # Directories to ignore in scan
